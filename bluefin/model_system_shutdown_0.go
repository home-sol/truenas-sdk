...
// checks if the SystemShutdown0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemShutdown0{}
...
func (o SystemShutdown0) ToMap() (map[string]interface{}, error) {
