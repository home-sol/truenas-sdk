...
// checks if the ReplicationGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicationGetInstance1{}

// ReplicationGetInstance1 struct for ReplicationGetInstance1
type ReplicationGetInstance1 struct {
...
func (o *ReplicationGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *ReplicationGetInstance1) SetExtendContextNil() {
...
func (o *ReplicationGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o ReplicationGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o ReplicationGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableReplicationGetInstance1 struct {
	value *ReplicationGetInstance1
	isSet bool
}

func (v NullableReplicationGetInstance1) Get() *ReplicationGetInstance1 {
	return v.value
}

func (v *NullableReplicationGetInstance1) Set(val *ReplicationGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableReplicationGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableReplicationGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReplicationGetInstance1(val *ReplicationGetInstance1) *NullableReplicationGetInstance1 {
	return &NullableReplicationGetInstance1{value: val, isSet: true}
}

func (v NullableReplicationGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReplicationGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
