...
// checks if the CronjobGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CronjobGetInstance1{}

// CronjobGetInstance1 struct for CronjobGetInstance1
type CronjobGetInstance1 struct {
...
func (o *CronjobGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *CronjobGetInstance1) SetExtendContextNil() {
...
func (o *CronjobGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o CronjobGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o CronjobGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableCronjobGetInstance1 struct {
	value *CronjobGetInstance1
	isSet bool
}

func (v NullableCronjobGetInstance1) Get() *CronjobGetInstance1 {
	return v.value
}

func (v *NullableCronjobGetInstance1) Set(val *CronjobGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableCronjobGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableCronjobGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCronjobGetInstance1(val *CronjobGetInstance1) *NullableCronjobGetInstance1 {
	return &NullableCronjobGetInstance1{value: val, isSet: true}
}

func (v NullableCronjobGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCronjobGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
