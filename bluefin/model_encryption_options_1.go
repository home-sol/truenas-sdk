...
// checks if the EncryptionOptions1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EncryptionOptions1{}

// EncryptionOptions1 `encryption_options` specifies configuration for encryption of dataset for `name` pool. `encryption_options.passphrase` must be specified if encryption for dataset is desired with a passphrase as a key. Otherwise a hex encoded key can be specified by providing `encryption_options.key`. `encryption_options.generate_key` when enabled automatically generates the key to be used for dataset encryption.
type EncryptionOptions1 struct {
...
func (o *EncryptionOptions1) SetPassphraseNil() {
...
func (o *EncryptionOptions1) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o EncryptionOptions1) MarshalJSON() ([]byte, error) {
...
func (o EncryptionOptions1) ToMap() (map[string]interface{}, error) {
...
type NullableEncryptionOptions1 struct {
	value *EncryptionOptions1
	isSet bool
}

func (v NullableEncryptionOptions1) Get() *EncryptionOptions1 {
	return v.value
}

func (v *NullableEncryptionOptions1) Set(val *EncryptionOptions1) {
	v.value = val
	v.isSet = true
}

func (v NullableEncryptionOptions1) IsSet() bool {
	return v.isSet
}

func (v *NullableEncryptionOptions1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncryptionOptions1(val *EncryptionOptions1) *NullableEncryptionOptions1 {
	return &NullableEncryptionOptions1{value: val, isSet: true}
}

func (v NullableEncryptionOptions1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncryptionOptions1) UnmarshalJSON(src []byte) error {
	v.isSet = true
