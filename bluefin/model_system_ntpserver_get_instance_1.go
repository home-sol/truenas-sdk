...
// checks if the SystemNtpserverGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemNtpserverGetInstance1{}

// SystemNtpserverGetInstance1 struct for SystemNtpserverGetInstance1
type SystemNtpserverGetInstance1 struct {
...
func NewSystemNtpserverGetInstance1() *SystemNtpserverGetInstance1 {
	this := SystemNtpserverGetInstance1{}
...
func (o *SystemNtpserverGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *SystemNtpserverGetInstance1) SetExtendContextNil() {
...
func (o *SystemNtpserverGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o SystemNtpserverGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o SystemNtpserverGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableSystemNtpserverGetInstance1 struct {
	value *SystemNtpserverGetInstance1
	isSet bool
}

func (v NullableSystemNtpserverGetInstance1) Get() *SystemNtpserverGetInstance1 {
	return v.value
}

func (v *NullableSystemNtpserverGetInstance1) Set(val *SystemNtpserverGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemNtpserverGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemNtpserverGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemNtpserverGetInstance1(val *SystemNtpserverGetInstance1) *NullableSystemNtpserverGetInstance1 {
	return &NullableSystemNtpserverGetInstance1{value: val, isSet: true}
}

func (v NullableSystemNtpserverGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemNtpserverGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
