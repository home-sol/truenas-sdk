...
// checks if the PoolScrubGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolScrubGetInstance1{}

// PoolScrubGetInstance1 struct for PoolScrubGetInstance1
type PoolScrubGetInstance1 struct {
...
func (o *PoolScrubGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *PoolScrubGetInstance1) SetExtendContextNil() {
...
func (o *PoolScrubGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o PoolScrubGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o PoolScrubGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullablePoolScrubGetInstance1 struct {
	value *PoolScrubGetInstance1
	isSet bool
}

func (v NullablePoolScrubGetInstance1) Get() *PoolScrubGetInstance1 {
	return v.value
}

func (v *NullablePoolScrubGetInstance1) Set(val *PoolScrubGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullablePoolScrubGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullablePoolScrubGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoolScrubGetInstance1(val *PoolScrubGetInstance1) *NullablePoolScrubGetInstance1 {
	return &NullablePoolScrubGetInstance1{value: val, isSet: true}
}

func (v NullablePoolScrubGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoolScrubGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
