...
// checks if the BootenvGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BootenvGetInstance1{}

// BootenvGetInstance1 struct for BootenvGetInstance1
type BootenvGetInstance1 struct {
...
func (o *BootenvGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *BootenvGetInstance1) SetExtendContextNil() {
...
func (o *BootenvGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o BootenvGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o BootenvGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableBootenvGetInstance1 struct {
	value *BootenvGetInstance1
	isSet bool
}

func (v NullableBootenvGetInstance1) Get() *BootenvGetInstance1 {
	return v.value
}

func (v *NullableBootenvGetInstance1) Set(val *BootenvGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableBootenvGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableBootenvGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootenvGetInstance1(val *BootenvGetInstance1) *NullableBootenvGetInstance1 {
	return &NullableBootenvGetInstance1{value: val, isSet: true}
}

func (v NullableBootenvGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootenvGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
