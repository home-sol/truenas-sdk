...
// checks if the CloudsyncGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudsyncGetInstance1{}

// CloudsyncGetInstance1 struct for CloudsyncGetInstance1
type CloudsyncGetInstance1 struct {
...
func (o *CloudsyncGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *CloudsyncGetInstance1) SetExtendContextNil() {
...
func (o *CloudsyncGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o CloudsyncGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o CloudsyncGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableCloudsyncGetInstance1 struct {
	value *CloudsyncGetInstance1
	isSet bool
}

func (v NullableCloudsyncGetInstance1) Get() *CloudsyncGetInstance1 {
	return v.value
}

func (v *NullableCloudsyncGetInstance1) Set(val *CloudsyncGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudsyncGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudsyncGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudsyncGetInstance1(val *CloudsyncGetInstance1) *NullableCloudsyncGetInstance1 {
	return &NullableCloudsyncGetInstance1{value: val, isSet: true}
}

func (v NullableCloudsyncGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudsyncGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
