...
[**UserGetInstancePost**](UserApi.md#UserGetInstancePost) | **Post** /user/get_instance | 
...
[**UserHasLocalAdministratorSetUpGet**](UserApi.md#UserHasLocalAdministratorSetUpGet) | **Get** /user/has_local_administrator_set_up | 
...
func main() {
    ...
    r, err := apiClient.UserApi.UserGet(context.Background()).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
> UserGetInstancePost(ctx).UserGetInstance(userGetInstance).Execute()
...
func main() {
    userGetInstance := *openapiclient.NewUserGetInstance() // UserGetInstance |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserGetInstancePost(context.Background()).UserGetInstance(userGetInstance).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `UserApi.UserGetInstancePost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiUserGetInstancePostRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **userGetInstance** | [**UserGetInstance**](UserGetInstance.md) |  | 
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserGetNextUidGet(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserGetUserObjPost(context.Background()).UserGetUserObj0(userGetUserObj0).Execute()
    if err != nil {
...
## UserHasLocalAdministratorSetUpGet

> UserHasLocalAdministratorSetUpGet(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserHasLocalAdministratorSetUpGet(context.Background()).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `UserApi.UserHasLocalAdministratorSetUpGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiUserHasLocalAdministratorSetUpGetRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserHasRootPasswordGet(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserIdIdDelete(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserIdIdGet(context.Background(), id).Execute()
    if err != nil {
...
> UserIdIdPopAttributePost(ctx, id).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserIdIdPopAttributePost(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserIdIdPut(context.Background(), id).Execute()
    if err != nil {
...
> UserIdIdSetAttributePost(ctx, id).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserIdIdSetAttributePost(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserPost(context.Background()).UserCreate0(userCreate0).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.UserApi.UserShellChoicesPost(context.Background()).Body(body).Execute()
    if err != nil {
