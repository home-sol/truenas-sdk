...
// checks if the PoolSnapshottaskGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolSnapshottaskGetInstance1{}

// PoolSnapshottaskGetInstance1 struct for PoolSnapshottaskGetInstance1
type PoolSnapshottaskGetInstance1 struct {
...
func NewPoolSnapshottaskGetInstance1() *PoolSnapshottaskGetInstance1 {
	this := PoolSnapshottaskGetInstance1{}
...
func (o *PoolSnapshottaskGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *PoolSnapshottaskGetInstance1) SetExtendContextNil() {
...
func (o *PoolSnapshottaskGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o PoolSnapshottaskGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o PoolSnapshottaskGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullablePoolSnapshottaskGetInstance1 struct {
	value *PoolSnapshottaskGetInstance1
	isSet bool
}

func (v NullablePoolSnapshottaskGetInstance1) Get() *PoolSnapshottaskGetInstance1 {
	return v.value
}

func (v *NullablePoolSnapshottaskGetInstance1) Set(val *PoolSnapshottaskGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullablePoolSnapshottaskGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullablePoolSnapshottaskGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoolSnapshottaskGetInstance1(val *PoolSnapshottaskGetInstance1) *NullablePoolSnapshottaskGetInstance1 {
	return &NullablePoolSnapshottaskGetInstance1{value: val, isSet: true}
}

func (v NullablePoolSnapshottaskGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoolSnapshottaskGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
