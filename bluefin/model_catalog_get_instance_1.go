...
// checks if the CatalogGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogGetInstance1{}

// CatalogGetInstance1 struct for CatalogGetInstance1
type CatalogGetInstance1 struct {
...
func (o *CatalogGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *CatalogGetInstance1) SetExtendContextNil() {
...
func (o *CatalogGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o CatalogGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o CatalogGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogGetInstance1 struct {
	value *CatalogGetInstance1
	isSet bool
}

func (v NullableCatalogGetInstance1) Get() *CatalogGetInstance1 {
	return v.value
}

func (v *NullableCatalogGetInstance1) Set(val *CatalogGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogGetInstance1(val *CatalogGetInstance1) *NullableCatalogGetInstance1 {
	return &NullableCatalogGetInstance1{value: val, isSet: true}
}

func (v NullableCatalogGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
