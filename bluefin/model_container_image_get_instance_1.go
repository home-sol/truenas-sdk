...
// checks if the ContainerImageGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContainerImageGetInstance1{}

// ContainerImageGetInstance1 struct for ContainerImageGetInstance1
type ContainerImageGetInstance1 struct {
...
func NewContainerImageGetInstance1() *ContainerImageGetInstance1 {
	this := ContainerImageGetInstance1{}
...
func (o *ContainerImageGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *ContainerImageGetInstance1) SetExtendContextNil() {
...
func (o *ContainerImageGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o ContainerImageGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o ContainerImageGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableContainerImageGetInstance1 struct {
	value *ContainerImageGetInstance1
	isSet bool
}

func (v NullableContainerImageGetInstance1) Get() *ContainerImageGetInstance1 {
	return v.value
}

func (v *NullableContainerImageGetInstance1) Set(val *ContainerImageGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableContainerImageGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableContainerImageGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContainerImageGetInstance1(val *ContainerImageGetInstance1) *NullableContainerImageGetInstance1 {
	return &NullableContainerImageGetInstance1{value: val, isSet: true}
}

func (v NullableContainerImageGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContainerImageGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
