...
// checks if the GlusterVolumeGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlusterVolumeGetInstance1{}

// GlusterVolumeGetInstance1 struct for GlusterVolumeGetInstance1
type GlusterVolumeGetInstance1 struct {
...
func NewGlusterVolumeGetInstance1() *GlusterVolumeGetInstance1 {
	this := GlusterVolumeGetInstance1{}
...
func (o *GlusterVolumeGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *GlusterVolumeGetInstance1) SetExtendContextNil() {
...
func (o *GlusterVolumeGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o GlusterVolumeGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o GlusterVolumeGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableGlusterVolumeGetInstance1 struct {
	value *GlusterVolumeGetInstance1
	isSet bool
}

func (v NullableGlusterVolumeGetInstance1) Get() *GlusterVolumeGetInstance1 {
	return v.value
}

func (v *NullableGlusterVolumeGetInstance1) Set(val *GlusterVolumeGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableGlusterVolumeGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableGlusterVolumeGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGlusterVolumeGetInstance1(val *GlusterVolumeGetInstance1) *NullableGlusterVolumeGetInstance1 {
	return &NullableGlusterVolumeGetInstance1{value: val, isSet: true}
}

func (v NullableGlusterVolumeGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGlusterVolumeGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
