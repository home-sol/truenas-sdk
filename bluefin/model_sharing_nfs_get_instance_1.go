...
// checks if the SharingNfsGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SharingNfsGetInstance1{}

// SharingNfsGetInstance1 struct for SharingNfsGetInstance1
type SharingNfsGetInstance1 struct {
...
func (o *SharingNfsGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *SharingNfsGetInstance1) SetExtendContextNil() {
...
func (o *SharingNfsGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o SharingNfsGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o SharingNfsGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableSharingNfsGetInstance1 struct {
	value *SharingNfsGetInstance1
	isSet bool
}

func (v NullableSharingNfsGetInstance1) Get() *SharingNfsGetInstance1 {
	return v.value
}

func (v *NullableSharingNfsGetInstance1) Set(val *SharingNfsGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableSharingNfsGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableSharingNfsGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSharingNfsGetInstance1(val *SharingNfsGetInstance1) *NullableSharingNfsGetInstance1 {
	return &NullableSharingNfsGetInstance1{value: val, isSet: true}
}

func (v NullableSharingNfsGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSharingNfsGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
