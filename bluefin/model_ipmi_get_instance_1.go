...
// checks if the IpmiGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpmiGetInstance1{}

// IpmiGetInstance1 struct for IpmiGetInstance1
type IpmiGetInstance1 struct {
...
func (o *IpmiGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IpmiGetInstance1) SetExtendContextNil() {
...
func (o *IpmiGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IpmiGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IpmiGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIpmiGetInstance1 struct {
	value *IpmiGetInstance1
	isSet bool
}

func (v NullableIpmiGetInstance1) Get() *IpmiGetInstance1 {
	return v.value
}

func (v *NullableIpmiGetInstance1) Set(val *IpmiGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIpmiGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIpmiGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpmiGetInstance1(val *IpmiGetInstance1) *NullableIpmiGetInstance1 {
	return &NullableIpmiGetInstance1{value: val, isSet: true}
}

func (v NullableIpmiGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpmiGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
