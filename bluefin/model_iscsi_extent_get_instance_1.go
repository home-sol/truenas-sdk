...
// checks if the IscsiExtentGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiExtentGetInstance1{}

// IscsiExtentGetInstance1 struct for IscsiExtentGetInstance1
type IscsiExtentGetInstance1 struct {
...
func (o *IscsiExtentGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IscsiExtentGetInstance1) SetExtendContextNil() {
...
func (o *IscsiExtentGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IscsiExtentGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IscsiExtentGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIscsiExtentGetInstance1 struct {
	value *IscsiExtentGetInstance1
	isSet bool
}

func (v NullableIscsiExtentGetInstance1) Get() *IscsiExtentGetInstance1 {
	return v.value
}

func (v *NullableIscsiExtentGetInstance1) Set(val *IscsiExtentGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIscsiExtentGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIscsiExtentGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIscsiExtentGetInstance1(val *IscsiExtentGetInstance1) *NullableIscsiExtentGetInstance1 {
	return &NullableIscsiExtentGetInstance1{value: val, isSet: true}
}

func (v NullableIscsiExtentGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIscsiExtentGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
