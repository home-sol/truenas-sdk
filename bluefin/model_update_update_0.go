...
// checks if the UpdateUpdate0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUpdate0{}
...
func (o UpdateUpdate0) ToMap() (map[string]interface{}, error) {
