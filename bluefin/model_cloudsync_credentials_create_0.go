...
// checks if the CloudsyncCredentialsCreate0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudsyncCredentialsCreate0{}
...
func (o CloudsyncCredentialsCreate0) ToMap() (map[string]interface{}, error) {
