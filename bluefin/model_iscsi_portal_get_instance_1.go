...
// checks if the IscsiPortalGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiPortalGetInstance1{}

// IscsiPortalGetInstance1 struct for IscsiPortalGetInstance1
type IscsiPortalGetInstance1 struct {
...
func (o *IscsiPortalGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IscsiPortalGetInstance1) SetExtendContextNil() {
...
func (o *IscsiPortalGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IscsiPortalGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IscsiPortalGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIscsiPortalGetInstance1 struct {
	value *IscsiPortalGetInstance1
	isSet bool
}

func (v NullableIscsiPortalGetInstance1) Get() *IscsiPortalGetInstance1 {
	return v.value
}

func (v *NullableIscsiPortalGetInstance1) Set(val *IscsiPortalGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIscsiPortalGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIscsiPortalGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIscsiPortalGetInstance1(val *IscsiPortalGetInstance1) *NullableIscsiPortalGetInstance1 {
	return &NullableIscsiPortalGetInstance1{value: val, isSet: true}
}

func (v NullableIscsiPortalGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIscsiPortalGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
