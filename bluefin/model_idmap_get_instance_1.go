...
// checks if the IdmapGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdmapGetInstance1{}

// IdmapGetInstance1 struct for IdmapGetInstance1
type IdmapGetInstance1 struct {
...
func (o *IdmapGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IdmapGetInstance1) SetExtendContextNil() {
...
func (o *IdmapGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IdmapGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IdmapGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIdmapGetInstance1 struct {
	value *IdmapGetInstance1
	isSet bool
}

func (v NullableIdmapGetInstance1) Get() *IdmapGetInstance1 {
	return v.value
}

func (v *NullableIdmapGetInstance1) Set(val *IdmapGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIdmapGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIdmapGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdmapGetInstance1(val *IdmapGetInstance1) *NullableIdmapGetInstance1 {
	return &NullableIdmapGetInstance1{value: val, isSet: true}
}

func (v NullableIdmapGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdmapGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
