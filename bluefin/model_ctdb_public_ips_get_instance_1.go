...
// checks if the CtdbPublicIpsGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CtdbPublicIpsGetInstance1{}

// CtdbPublicIpsGetInstance1 struct for CtdbPublicIpsGetInstance1
type CtdbPublicIpsGetInstance1 struct {
...
func NewCtdbPublicIpsGetInstance1() *CtdbPublicIpsGetInstance1 {
	this := CtdbPublicIpsGetInstance1{}
...
func (o *CtdbPublicIpsGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *CtdbPublicIpsGetInstance1) SetExtendContextNil() {
...
func (o *CtdbPublicIpsGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o CtdbPublicIpsGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o CtdbPublicIpsGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableCtdbPublicIpsGetInstance1 struct {
	value *CtdbPublicIpsGetInstance1
	isSet bool
}

func (v NullableCtdbPublicIpsGetInstance1) Get() *CtdbPublicIpsGetInstance1 {
	return v.value
}

func (v *NullableCtdbPublicIpsGetInstance1) Set(val *CtdbPublicIpsGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableCtdbPublicIpsGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableCtdbPublicIpsGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCtdbPublicIpsGetInstance1(val *CtdbPublicIpsGetInstance1) *NullableCtdbPublicIpsGetInstance1 {
	return &NullableCtdbPublicIpsGetInstance1{value: val, isSet: true}
}

func (v NullableCtdbPublicIpsGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCtdbPublicIpsGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
