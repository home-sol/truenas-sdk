...
// checks if the SshUpdate0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshUpdate0{}
...
func (o *SshUpdate0) GetSftpLogFacility() string {
	if o == nil || IsNil(o.SftpLogFacility) {
		var ret string
		return ret
	}
...
func (o SshUpdate0) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Bindiface) {
	...
	if !IsNil(o.Adminlogin) {
		toSerialize["adminlogin"] = o.Adminlogin
	}
