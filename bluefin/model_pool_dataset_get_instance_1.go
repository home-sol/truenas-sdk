...
// checks if the PoolDatasetGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolDatasetGetInstance1{}

// PoolDatasetGetInstance1 struct for PoolDatasetGetInstance1
type PoolDatasetGetInstance1 struct {
...
func (o *PoolDatasetGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *PoolDatasetGetInstance1) SetExtendContextNil() {
...
func (o *PoolDatasetGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o PoolDatasetGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o PoolDatasetGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullablePoolDatasetGetInstance1 struct {
	value *PoolDatasetGetInstance1
	isSet bool
}

func (v NullablePoolDatasetGetInstance1) Get() *PoolDatasetGetInstance1 {
	return v.value
}

func (v *NullablePoolDatasetGetInstance1) Set(val *PoolDatasetGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullablePoolDatasetGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullablePoolDatasetGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoolDatasetGetInstance1(val *PoolDatasetGetInstance1) *NullablePoolDatasetGetInstance1 {
	return &NullablePoolDatasetGetInstance1{value: val, isSet: true}
}

func (v NullablePoolDatasetGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoolDatasetGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
