...
// checks if the KerberosRealmCreate0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosRealmCreate0{}
...
func (o *KerberosRealmCreate0) GetKpasswdServer() []interface{} {
	if o == nil || IsNil(o.KpasswdServer) {
		var ret []interface{}
		return ret
	}
...
func (o KerberosRealmCreate0) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdminServer) {
		toSerialize["admin_server"] = o.AdminServer
	}
	if !IsNil(o.KpasswdServer) {
