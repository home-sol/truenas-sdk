...
// checks if the IscsiAuthGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiAuthGetInstance1{}

// IscsiAuthGetInstance1 struct for IscsiAuthGetInstance1
type IscsiAuthGetInstance1 struct {
...
func (o *IscsiAuthGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IscsiAuthGetInstance1) SetExtendContextNil() {
...
func (o *IscsiAuthGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IscsiAuthGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IscsiAuthGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIscsiAuthGetInstance1 struct {
	value *IscsiAuthGetInstance1
	isSet bool
}

func (v NullableIscsiAuthGetInstance1) Get() *IscsiAuthGetInstance1 {
	return v.value
}

func (v *NullableIscsiAuthGetInstance1) Set(val *IscsiAuthGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIscsiAuthGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIscsiAuthGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIscsiAuthGetInstance1(val *IscsiAuthGetInstance1) *NullableIscsiAuthGetInstance1 {
	return &NullableIscsiAuthGetInstance1{value: val, isSet: true}
}

func (v NullableIscsiAuthGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIscsiAuthGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
