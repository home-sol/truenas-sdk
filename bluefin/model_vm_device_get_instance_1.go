...
// checks if the VmDeviceGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDeviceGetInstance1{}

// VmDeviceGetInstance1 struct for VmDeviceGetInstance1
type VmDeviceGetInstance1 struct {
...
func (o *VmDeviceGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *VmDeviceGetInstance1) SetExtendContextNil() {
...
func (o *VmDeviceGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o VmDeviceGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o VmDeviceGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableVmDeviceGetInstance1 struct {
	value *VmDeviceGetInstance1
	isSet bool
}

func (v NullableVmDeviceGetInstance1) Get() *VmDeviceGetInstance1 {
	return v.value
}

func (v *NullableVmDeviceGetInstance1) Set(val *VmDeviceGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableVmDeviceGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableVmDeviceGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmDeviceGetInstance1(val *VmDeviceGetInstance1) *NullableVmDeviceGetInstance1 {
	return &NullableVmDeviceGetInstance1{value: val, isSet: true}
}

func (v NullableVmDeviceGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmDeviceGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
