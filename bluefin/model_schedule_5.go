...
// checks if the Schedule5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Schedule5{}

// Schedule5 struct for Schedule5
type Schedule5 struct {
...
func (o Schedule5) MarshalJSON() ([]byte, error) {
...
func (o Schedule5) ToMap() (map[string]interface{}, error) {
...
type NullableSchedule5 struct {
	value *Schedule5
	isSet bool
}

func (v NullableSchedule5) Get() *Schedule5 {
	return v.value
}

func (v *NullableSchedule5) Set(val *Schedule5) {
	v.value = val
	v.isSet = true
}

func (v NullableSchedule5) IsSet() bool {
	return v.isSet
}

func (v *NullableSchedule5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchedule5(val *Schedule5) *NullableSchedule5 {
	return &NullableSchedule5{value: val, isSet: true}
}

func (v NullableSchedule5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchedule5) UnmarshalJSON(src []byte) error {
	v.isSet = true
