...
// checks if the UserGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGetInstance1{}

// UserGetInstance1 struct for UserGetInstance1
type UserGetInstance1 struct {
...
func (o *UserGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *UserGetInstance1) SetExtendContextNil() {
...
func (o *UserGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o UserGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o UserGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableUserGetInstance1 struct {
	value *UserGetInstance1
	isSet bool
}

func (v NullableUserGetInstance1) Get() *UserGetInstance1 {
	return v.value
}

func (v *NullableUserGetInstance1) Set(val *UserGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGetInstance1(val *UserGetInstance1) *NullableUserGetInstance1 {
	return &NullableUserGetInstance1{value: val, isSet: true}
}

func (v NullableUserGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
