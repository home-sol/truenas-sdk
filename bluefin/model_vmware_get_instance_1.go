...
// checks if the VmwareGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmwareGetInstance1{}

// VmwareGetInstance1 struct for VmwareGetInstance1
type VmwareGetInstance1 struct {
...
func (o *VmwareGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *VmwareGetInstance1) SetExtendContextNil() {
...
func (o *VmwareGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o VmwareGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o VmwareGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableVmwareGetInstance1 struct {
	value *VmwareGetInstance1
	isSet bool
}

func (v NullableVmwareGetInstance1) Get() *VmwareGetInstance1 {
	return v.value
}

func (v *NullableVmwareGetInstance1) Set(val *VmwareGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableVmwareGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableVmwareGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmwareGetInstance1(val *VmwareGetInstance1) *NullableVmwareGetInstance1 {
	return &NullableVmwareGetInstance1{value: val, isSet: true}
}

func (v NullableVmwareGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmwareGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
