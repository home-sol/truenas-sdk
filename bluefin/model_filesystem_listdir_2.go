...
// checks if the FilesystemListdir2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FilesystemListdir2{}
...
func (o FilesystemListdir2) ToMap() (map[string]interface{}, error) {
