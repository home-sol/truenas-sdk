...
// checks if the KerberosRealmGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosRealmGetInstance1{}

// KerberosRealmGetInstance1 struct for KerberosRealmGetInstance1
type KerberosRealmGetInstance1 struct {
...
func NewKerberosRealmGetInstance1() *KerberosRealmGetInstance1 {
	this := KerberosRealmGetInstance1{}
...
func (o *KerberosRealmGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *KerberosRealmGetInstance1) SetExtendContextNil() {
...
func (o *KerberosRealmGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o KerberosRealmGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o KerberosRealmGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableKerberosRealmGetInstance1 struct {
	value *KerberosRealmGetInstance1
	isSet bool
}

func (v NullableKerberosRealmGetInstance1) Get() *KerberosRealmGetInstance1 {
	return v.value
}

func (v *NullableKerberosRealmGetInstance1) Set(val *KerberosRealmGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableKerberosRealmGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableKerberosRealmGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKerberosRealmGetInstance1(val *KerberosRealmGetInstance1) *NullableKerberosRealmGetInstance1 {
	return &NullableKerberosRealmGetInstance1{value: val, isSet: true}
}

func (v NullableKerberosRealmGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKerberosRealmGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
