...
// checks if the RsyncmodGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RsyncmodGetInstance1{}

// RsyncmodGetInstance1 struct for RsyncmodGetInstance1
type RsyncmodGetInstance1 struct {
...
func (o *RsyncmodGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *RsyncmodGetInstance1) SetExtendContextNil() {
...
func (o *RsyncmodGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o RsyncmodGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o RsyncmodGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableRsyncmodGetInstance1 struct {
	value *RsyncmodGetInstance1
	isSet bool
}

func (v NullableRsyncmodGetInstance1) Get() *RsyncmodGetInstance1 {
	return v.value
}

func (v *NullableRsyncmodGetInstance1) Set(val *RsyncmodGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableRsyncmodGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableRsyncmodGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRsyncmodGetInstance1(val *RsyncmodGetInstance1) *NullableRsyncmodGetInstance1 {
	return &NullableRsyncmodGetInstance1{value: val, isSet: true}
}

func (v NullableRsyncmodGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRsyncmodGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
