...
// checks if the PoolDatasetUserpropGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolDatasetUserpropGetInstance1{}

// PoolDatasetUserpropGetInstance1 struct for PoolDatasetUserpropGetInstance1
type PoolDatasetUserpropGetInstance1 struct {
...
func NewPoolDatasetUserpropGetInstance1() *PoolDatasetUserpropGetInstance1 {
	this := PoolDatasetUserpropGetInstance1{}
...
func (o *PoolDatasetUserpropGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *PoolDatasetUserpropGetInstance1) SetExtendContextNil() {
...
func (o *PoolDatasetUserpropGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o PoolDatasetUserpropGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o PoolDatasetUserpropGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullablePoolDatasetUserpropGetInstance1 struct {
	value *PoolDatasetUserpropGetInstance1
	isSet bool
}

func (v NullablePoolDatasetUserpropGetInstance1) Get() *PoolDatasetUserpropGetInstance1 {
	return v.value
}

func (v *NullablePoolDatasetUserpropGetInstance1) Set(val *PoolDatasetUserpropGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullablePoolDatasetUserpropGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullablePoolDatasetUserpropGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoolDatasetUserpropGetInstance1(val *PoolDatasetUserpropGetInstance1) *NullablePoolDatasetUserpropGetInstance1 {
	return &NullablePoolDatasetUserpropGetInstance1{value: val, isSet: true}
}

func (v NullablePoolDatasetUserpropGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoolDatasetUserpropGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
