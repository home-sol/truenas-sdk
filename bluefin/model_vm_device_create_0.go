...
// checks if the VmDeviceCreate0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmDeviceCreate0{}
...
func (o VmDeviceCreate0) ToMap() (map[string]interface{}, error) {
