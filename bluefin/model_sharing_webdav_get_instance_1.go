...
// checks if the SharingWebdavGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SharingWebdavGetInstance1{}

// SharingWebdavGetInstance1 struct for SharingWebdavGetInstance1
type SharingWebdavGetInstance1 struct {
...
func NewSharingWebdavGetInstance1() *SharingWebdavGetInstance1 {
	this := SharingWebdavGetInstance1{}
...
func (o *SharingWebdavGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *SharingWebdavGetInstance1) SetExtendContextNil() {
...
func (o *SharingWebdavGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o SharingWebdavGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o SharingWebdavGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableSharingWebdavGetInstance1 struct {
	value *SharingWebdavGetInstance1
	isSet bool
}

func (v NullableSharingWebdavGetInstance1) Get() *SharingWebdavGetInstance1 {
	return v.value
}

func (v *NullableSharingWebdavGetInstance1) Set(val *SharingWebdavGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableSharingWebdavGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableSharingWebdavGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSharingWebdavGetInstance1(val *SharingWebdavGetInstance1) *NullableSharingWebdavGetInstance1 {
	return &NullableSharingWebdavGetInstance1{value: val, isSet: true}
}

func (v NullableSharingWebdavGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSharingWebdavGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
