...
// checks if the ZfsSnapshotGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZfsSnapshotGetInstance1{}

// ZfsSnapshotGetInstance1 struct for ZfsSnapshotGetInstance1
type ZfsSnapshotGetInstance1 struct {
...
func (o *ZfsSnapshotGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *ZfsSnapshotGetInstance1) SetExtendContextNil() {
...
func (o *ZfsSnapshotGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o ZfsSnapshotGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o ZfsSnapshotGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableZfsSnapshotGetInstance1 struct {
	value *ZfsSnapshotGetInstance1
	isSet bool
}

func (v NullableZfsSnapshotGetInstance1) Get() *ZfsSnapshotGetInstance1 {
	return v.value
}

func (v *NullableZfsSnapshotGetInstance1) Set(val *ZfsSnapshotGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableZfsSnapshotGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableZfsSnapshotGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZfsSnapshotGetInstance1(val *ZfsSnapshotGetInstance1) *NullableZfsSnapshotGetInstance1 {
	return &NullableZfsSnapshotGetInstance1{value: val, isSet: true}
}

func (v NullableZfsSnapshotGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZfsSnapshotGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
