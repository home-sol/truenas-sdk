...
// checks if the SystemAdvancedUpdate0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemAdvancedUpdate0{}
...
type SystemAdvancedUpdate0 struct {
	...
	KdumpEnabled *bool  `json:"kdump_enabled,omitempty"`
	...
	IsolatedGpuPciIds             []string      `json:"isolated_gpu_pci_ids,omitempty"`
	KernelExtraOptions            *string       `json:"kernel_extra_options,omitempty"`
...
// GetKdumpEnabled returns the KdumpEnabled field value if set, zero value otherwise.
func (o *SystemAdvancedUpdate0) GetKdumpEnabled() bool {
	if o == nil || IsNil(o.KdumpEnabled) {
		var ret bool
		return ret
	}
	return *o.KdumpEnabled
}

// GetKdumpEnabledOk returns a tuple with the KdumpEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemAdvancedUpdate0) GetKdumpEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.KdumpEnabled) {
		return nil, false
	}
	return o.KdumpEnabled, true
}
...
// SetKdumpEnabled gets a reference to the given bool and assigns it to the KdumpEnabled field.
...
func (o *SystemAdvancedUpdate0) GetSerialconsole() bool {
	if o == nil || IsNil(o.Serialconsole) {
		var ret bool
		return ret
	}
...
func (o *SystemAdvancedUpdate0) GetOverprovision() int32 {
	if o == nil || IsNil(o.Overprovision.Get()) {
		var ret int32
		return ret
	}
...
func (o *SystemAdvancedUpdate0) GetSyslogTransport() string {
	if o == nil || IsNil(o.SyslogTransport) {
		var ret string
		return ret
	}
...
func (o *SystemAdvancedUpdate0) GetSyslogTlsCertificate() int32 {
	if o == nil || IsNil(o.SyslogTlsCertificate.Get()) {
		var ret int32
		return ret
	}
...
func (o *SystemAdvancedUpdate0) GetSyslogTlsCertificateAuthority() int32 {
	if o == nil || IsNil(o.SyslogTlsCertificateAuthority.Get()) {
		var ret int32
		return ret
	}
...
// GetIsolatedGpuPciIds returns the IsolatedGpuPciIds field value if set, zero value otherwise.
func (o *SystemAdvancedUpdate0) GetIsolatedGpuPciIds() []string {
	if o == nil || IsNil(o.IsolatedGpuPciIds) {
		var ret []string
		return ret
	}
	return o.IsolatedGpuPciIds
}

// GetIsolatedGpuPciIdsOk returns a tuple with the IsolatedGpuPciIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemAdvancedUpdate0) GetIsolatedGpuPciIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.IsolatedGpuPciIds) {
		return nil, false
	}
	return o.IsolatedGpuPciIds, true
}
...
// SetIsolatedGpuPciIds gets a reference to the given []string and assigns it to the IsolatedGpuPciIds field.
func (o *SystemAdvancedUpdate0) SetIsolatedGpuPciIds(v []string) {
	o.IsolatedGpuPciIds = v
}

// GetKernelExtraOptions returns the KernelExtraOptions field value if set, zero value otherwise.
func (o *SystemAdvancedUpdate0) GetKernelExtraOptions() string {
	if o == nil || IsNil(o.KernelExtraOptions) {
		var ret string
		return ret
	}
	return *o.KernelExtraOptions
}

// GetKernelExtraOptionsOk returns a tuple with the KernelExtraOptions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SystemAdvancedUpdate0) GetKernelExtraOptionsOk() (*string, bool) {
	if o == nil || IsNil(o.KernelExtraOptions) {
		return nil, false
	}
	return o.KernelExtraOptions, true
}
...
// SetKernelExtraOptions gets a reference to the given string and assigns it to the KernelExtraOptions field.
func (o *SystemAdvancedUpdate0) SetKernelExtraOptions(v string) {
	o.KernelExtraOptions = &v
}
...
func (o SystemAdvancedUpdate0) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsolatedGpuPciIds) {
		toSerialize["isolated_gpu_pci_ids"] = o.IsolatedGpuPciIds
	}
	if !IsNil(o.KernelExtraOptions) {
		toSerialize["kernel_extra_options"] = o.KernelExtraOptions
	}
	if !IsNil(o.SedPasswd) {
