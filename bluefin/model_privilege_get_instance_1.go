...
// checks if the PrivilegeGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrivilegeGetInstance1{}

// PrivilegeGetInstance1 struct for PrivilegeGetInstance1
type PrivilegeGetInstance1 struct {
...
func (o *PrivilegeGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *PrivilegeGetInstance1) SetExtendContextNil() {
...
func (o *PrivilegeGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o PrivilegeGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o PrivilegeGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullablePrivilegeGetInstance1 struct {
	value *PrivilegeGetInstance1
	isSet bool
}

func (v NullablePrivilegeGetInstance1) Get() *PrivilegeGetInstance1 {
	return v.value
}

func (v *NullablePrivilegeGetInstance1) Set(val *PrivilegeGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullablePrivilegeGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullablePrivilegeGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrivilegeGetInstance1(val *PrivilegeGetInstance1) *NullablePrivilegeGetInstance1 {
	return &NullablePrivilegeGetInstance1{value: val, isSet: true}
}

func (v NullablePrivilegeGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrivilegeGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
