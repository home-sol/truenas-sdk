...
// checks if the GlusterPeerGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlusterPeerGetInstance1{}

// GlusterPeerGetInstance1 struct for GlusterPeerGetInstance1
type GlusterPeerGetInstance1 struct {
...
func (o *GlusterPeerGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *GlusterPeerGetInstance1) SetExtendContextNil() {
...
func (o *GlusterPeerGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o GlusterPeerGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o GlusterPeerGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableGlusterPeerGetInstance1 struct {
	value *GlusterPeerGetInstance1
	isSet bool
}

func (v NullableGlusterPeerGetInstance1) Get() *GlusterPeerGetInstance1 {
	return v.value
}

func (v *NullableGlusterPeerGetInstance1) Set(val *GlusterPeerGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableGlusterPeerGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableGlusterPeerGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGlusterPeerGetInstance1(val *GlusterPeerGetInstance1) *NullableGlusterPeerGetInstance1 {
	return &NullableGlusterPeerGetInstance1{value: val, isSet: true}
}

func (v NullableGlusterPeerGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGlusterPeerGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
