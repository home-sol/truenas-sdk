...
// checks if the RsynctaskGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RsynctaskGetInstance1{}

// RsynctaskGetInstance1 struct for RsynctaskGetInstance1
type RsynctaskGetInstance1 struct {
...
func (o *RsynctaskGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *RsynctaskGetInstance1) SetExtendContextNil() {
...
func (o *RsynctaskGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o RsynctaskGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o RsynctaskGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableRsynctaskGetInstance1 struct {
	value *RsynctaskGetInstance1
	isSet bool
}

func (v NullableRsynctaskGetInstance1) Get() *RsynctaskGetInstance1 {
	return v.value
}

func (v *NullableRsynctaskGetInstance1) Set(val *RsynctaskGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableRsynctaskGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableRsynctaskGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRsynctaskGetInstance1(val *RsynctaskGetInstance1) *NullableRsynctaskGetInstance1 {
	return &NullableRsynctaskGetInstance1{value: val, isSet: true}
}

func (v NullableRsynctaskGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRsynctaskGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
