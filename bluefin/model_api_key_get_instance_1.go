...
// checks if the ApiKeyGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiKeyGetInstance1{}

// ApiKeyGetInstance1 struct for ApiKeyGetInstance1
type ApiKeyGetInstance1 struct {
...
func (o *ApiKeyGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *ApiKeyGetInstance1) SetExtendContextNil() {
...
func (o *ApiKeyGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o ApiKeyGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o ApiKeyGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableApiKeyGetInstance1 struct {
	value *ApiKeyGetInstance1
	isSet bool
}

func (v NullableApiKeyGetInstance1) Get() *ApiKeyGetInstance1 {
	return v.value
}

func (v *NullableApiKeyGetInstance1) Set(val *ApiKeyGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableApiKeyGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableApiKeyGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiKeyGetInstance1(val *ApiKeyGetInstance1) *NullableApiKeyGetInstance1 {
	return &NullableApiKeyGetInstance1{value: val, isSet: true}
}

func (v NullableApiKeyGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiKeyGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
