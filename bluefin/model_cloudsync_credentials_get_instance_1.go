...
// checks if the CloudsyncCredentialsGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudsyncCredentialsGetInstance1{}

// CloudsyncCredentialsGetInstance1 struct for CloudsyncCredentialsGetInstance1
type CloudsyncCredentialsGetInstance1 struct {
...
func NewCloudsyncCredentialsGetInstance1() *CloudsyncCredentialsGetInstance1 {
	this := CloudsyncCredentialsGetInstance1{}
...
func (o *CloudsyncCredentialsGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *CloudsyncCredentialsGetInstance1) SetExtendContextNil() {
...
func (o *CloudsyncCredentialsGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o CloudsyncCredentialsGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o CloudsyncCredentialsGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableCloudsyncCredentialsGetInstance1 struct {
	value *CloudsyncCredentialsGetInstance1
	isSet bool
}

func (v NullableCloudsyncCredentialsGetInstance1) Get() *CloudsyncCredentialsGetInstance1 {
	return v.value
}

func (v *NullableCloudsyncCredentialsGetInstance1) Set(val *CloudsyncCredentialsGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudsyncCredentialsGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudsyncCredentialsGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudsyncCredentialsGetInstance1(val *CloudsyncCredentialsGetInstance1) *NullableCloudsyncCredentialsGetInstance1 {
	return &NullableCloudsyncCredentialsGetInstance1{value: val, isSet: true}
}

func (v NullableCloudsyncCredentialsGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudsyncCredentialsGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
