...
// checks if the IscsiTargetextentCreate0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiTargetextentCreate0{}
...
func (o IscsiTargetextentCreate0) ToMap() (map[string]interface{}, error) {
