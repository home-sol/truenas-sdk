...
// checks if the AcmeDnsAuthenticatorGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcmeDnsAuthenticatorGetInstance1{}

// AcmeDnsAuthenticatorGetInstance1 struct for AcmeDnsAuthenticatorGetInstance1
type AcmeDnsAuthenticatorGetInstance1 struct {
...
func NewAcmeDnsAuthenticatorGetInstance1() *AcmeDnsAuthenticatorGetInstance1 {
	this := AcmeDnsAuthenticatorGetInstance1{}
...
func (o *AcmeDnsAuthenticatorGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *AcmeDnsAuthenticatorGetInstance1) SetExtendContextNil() {
...
func (o *AcmeDnsAuthenticatorGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o AcmeDnsAuthenticatorGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o AcmeDnsAuthenticatorGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableAcmeDnsAuthenticatorGetInstance1 struct {
	value *AcmeDnsAuthenticatorGetInstance1
	isSet bool
}

func (v NullableAcmeDnsAuthenticatorGetInstance1) Get() *AcmeDnsAuthenticatorGetInstance1 {
	return v.value
}

func (v *NullableAcmeDnsAuthenticatorGetInstance1) Set(val *AcmeDnsAuthenticatorGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableAcmeDnsAuthenticatorGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableAcmeDnsAuthenticatorGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcmeDnsAuthenticatorGetInstance1(val *AcmeDnsAuthenticatorGetInstance1) *NullableAcmeDnsAuthenticatorGetInstance1 {
	return &NullableAcmeDnsAuthenticatorGetInstance1{value: val, isSet: true}
}

func (v NullableAcmeDnsAuthenticatorGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcmeDnsAuthenticatorGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
