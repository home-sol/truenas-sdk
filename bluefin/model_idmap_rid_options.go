...
// checks if the IdmapRidOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdmapRidOptions{}
...
func (o IdmapRidOptions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SssdCompat) {
