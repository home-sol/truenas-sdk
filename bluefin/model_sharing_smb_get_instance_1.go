...
// checks if the SharingSmbGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SharingSmbGetInstance1{}

// SharingSmbGetInstance1 struct for SharingSmbGetInstance1
type SharingSmbGetInstance1 struct {
...
func (o *SharingSmbGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *SharingSmbGetInstance1) SetExtendContextNil() {
...
func (o *SharingSmbGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o SharingSmbGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o SharingSmbGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableSharingSmbGetInstance1 struct {
	value *SharingSmbGetInstance1
	isSet bool
}

func (v NullableSharingSmbGetInstance1) Get() *SharingSmbGetInstance1 {
	return v.value
}

func (v *NullableSharingSmbGetInstance1) Set(val *SharingSmbGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableSharingSmbGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableSharingSmbGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSharingSmbGetInstance1(val *SharingSmbGetInstance1) *NullableSharingSmbGetInstance1 {
	return &NullableSharingSmbGetInstance1{value: val, isSet: true}
}

func (v NullableSharingSmbGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSharingSmbGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
