...
// checks if the EnclosureGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnclosureGetInstance1{}

// EnclosureGetInstance1 struct for EnclosureGetInstance1
type EnclosureGetInstance1 struct {
...
func (o *EnclosureGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *EnclosureGetInstance1) SetExtendContextNil() {
...
func (o *EnclosureGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o EnclosureGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o EnclosureGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableEnclosureGetInstance1 struct {
	value *EnclosureGetInstance1
	isSet bool
}

func (v NullableEnclosureGetInstance1) Get() *EnclosureGetInstance1 {
	return v.value
}

func (v *NullableEnclosureGetInstance1) Set(val *EnclosureGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableEnclosureGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableEnclosureGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnclosureGetInstance1(val *EnclosureGetInstance1) *NullableEnclosureGetInstance1 {
	return &NullableEnclosureGetInstance1{value: val, isSet: true}
}

func (v NullableEnclosureGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnclosureGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
