...
// checks if the IscsiTargetextentGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiTargetextentGetInstance1{}

// IscsiTargetextentGetInstance1 struct for IscsiTargetextentGetInstance1
type IscsiTargetextentGetInstance1 struct {
...
func NewIscsiTargetextentGetInstance1() *IscsiTargetextentGetInstance1 {
	this := IscsiTargetextentGetInstance1{}
...
func (o *IscsiTargetextentGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IscsiTargetextentGetInstance1) SetExtendContextNil() {
...
func (o *IscsiTargetextentGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IscsiTargetextentGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IscsiTargetextentGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIscsiTargetextentGetInstance1 struct {
	value *IscsiTargetextentGetInstance1
	isSet bool
}

func (v NullableIscsiTargetextentGetInstance1) Get() *IscsiTargetextentGetInstance1 {
	return v.value
}

func (v *NullableIscsiTargetextentGetInstance1) Set(val *IscsiTargetextentGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIscsiTargetextentGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIscsiTargetextentGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIscsiTargetextentGetInstance1(val *IscsiTargetextentGetInstance1) *NullableIscsiTargetextentGetInstance1 {
	return &NullableIscsiTargetextentGetInstance1{value: val, isSet: true}
}

func (v NullableIscsiTargetextentGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIscsiTargetextentGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
