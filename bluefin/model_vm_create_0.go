...
// checks if the VmCreate0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmCreate0{}
...
func NewVmCreate0() *VmCreate0 {
	...
	var suspendOnSnapshot bool
	this.SuspendOnSnapshot = &suspendOnSnapshot
	var hypervEnlightenments bool
	this.HypervEnlightenments = &hypervEnlightenments
	var bootloader string
	this.Bootloader = &bootloader
	var bootloaderOvmf string
	this.BootloaderOvmf = &bootloaderOvmf
	var autostart bool
	this.Autostart = &autostart
	var hideFromMsr bool
	this.HideFromMsr = &hideFromMsr
	var ensureDisplayDevice bool
	this.EnsureDisplayDevice = &ensureDisplayDevice
	var time string
	this.Time = &time
	var shutdownTimeout int32
...
func (o *VmCreate0) SetNodesetNil() {
	o.Nodeset.Set(nil)
}
...
func (o *VmCreate0) SetMinMemoryNil() {
	o.MinMemory.Set(nil)
}
...
// GetBootloaderOvmf returns the BootloaderOvmf field value if set, zero value otherwise.
func (o *VmCreate0) GetBootloaderOvmf() string {
	if o == nil || IsNil(o.BootloaderOvmf) {
		var ret string
		return ret
	}
	return *o.BootloaderOvmf
}

// GetBootloaderOvmfOk returns a tuple with the BootloaderOvmf field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VmCreate0) GetBootloaderOvmfOk() (*string, bool) {
	if o == nil || IsNil(o.BootloaderOvmf) {
		return nil, false
	}
	return o.BootloaderOvmf, true
}
...
// SetBootloaderOvmf gets a reference to the given string and assigns it to the BootloaderOvmf field.
...
func (o VmCreate0) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BootloaderOvmf) {
		toSerialize["bootloader_ovmf"] = o.BootloaderOvmf
	}
