...
// checks if the SmbSharesecGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbSharesecGetInstance1{}

// SmbSharesecGetInstance1 struct for SmbSharesecGetInstance1
type SmbSharesecGetInstance1 struct {
...
func (o *SmbSharesecGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *SmbSharesecGetInstance1) SetExtendContextNil() {
...
func (o *SmbSharesecGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o SmbSharesecGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o SmbSharesecGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableSmbSharesecGetInstance1 struct {
	value *SmbSharesecGetInstance1
	isSet bool
}

func (v NullableSmbSharesecGetInstance1) Get() *SmbSharesecGetInstance1 {
	return v.value
}

func (v *NullableSmbSharesecGetInstance1) Set(val *SmbSharesecGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableSmbSharesecGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableSmbSharesecGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmbSharesecGetInstance1(val *SmbSharesecGetInstance1) *NullableSmbSharesecGetInstance1 {
	return &NullableSmbSharesecGetInstance1{value: val, isSet: true}
}

func (v NullableSmbSharesecGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmbSharesecGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
