...
// checks if the IscsiHostGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiHostGetInstance1{}

// IscsiHostGetInstance1 struct for IscsiHostGetInstance1
type IscsiHostGetInstance1 struct {
...
func (o *IscsiHostGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IscsiHostGetInstance1) SetExtendContextNil() {
...
func (o *IscsiHostGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IscsiHostGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IscsiHostGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIscsiHostGetInstance1 struct {
	value *IscsiHostGetInstance1
	isSet bool
}

func (v NullableIscsiHostGetInstance1) Get() *IscsiHostGetInstance1 {
	return v.value
}

func (v *NullableIscsiHostGetInstance1) Set(val *IscsiHostGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIscsiHostGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIscsiHostGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIscsiHostGetInstance1(val *IscsiHostGetInstance1) *NullableIscsiHostGetInstance1 {
	return &NullableIscsiHostGetInstance1{value: val, isSet: true}
}

func (v NullableIscsiHostGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIscsiHostGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
