...
// checks if the IscsiInitiatorGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiInitiatorGetInstance1{}

// IscsiInitiatorGetInstance1 struct for IscsiInitiatorGetInstance1
type IscsiInitiatorGetInstance1 struct {
...
func NewIscsiInitiatorGetInstance1() *IscsiInitiatorGetInstance1 {
	this := IscsiInitiatorGetInstance1{}
...
func (o *IscsiInitiatorGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IscsiInitiatorGetInstance1) SetExtendContextNil() {
...
func (o *IscsiInitiatorGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IscsiInitiatorGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IscsiInitiatorGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIscsiInitiatorGetInstance1 struct {
	value *IscsiInitiatorGetInstance1
	isSet bool
}

func (v NullableIscsiInitiatorGetInstance1) Get() *IscsiInitiatorGetInstance1 {
	return v.value
}

func (v *NullableIscsiInitiatorGetInstance1) Set(val *IscsiInitiatorGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIscsiInitiatorGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIscsiInitiatorGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIscsiInitiatorGetInstance1(val *IscsiInitiatorGetInstance1) *NullableIscsiInitiatorGetInstance1 {
	return &NullableIscsiInitiatorGetInstance1{value: val, isSet: true}
}

func (v NullableIscsiInitiatorGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIscsiInitiatorGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
