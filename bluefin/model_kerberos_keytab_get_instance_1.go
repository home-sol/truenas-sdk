...
// checks if the KerberosKeytabGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosKeytabGetInstance1{}

// KerberosKeytabGetInstance1 struct for KerberosKeytabGetInstance1
type KerberosKeytabGetInstance1 struct {
...
func NewKerberosKeytabGetInstance1() *KerberosKeytabGetInstance1 {
	this := KerberosKeytabGetInstance1{}
...
func (o *KerberosKeytabGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *KerberosKeytabGetInstance1) SetExtendContextNil() {
...
func (o *KerberosKeytabGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o KerberosKeytabGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o KerberosKeytabGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableKerberosKeytabGetInstance1 struct {
	value *KerberosKeytabGetInstance1
	isSet bool
}

func (v NullableKerberosKeytabGetInstance1) Get() *KerberosKeytabGetInstance1 {
	return v.value
}

func (v *NullableKerberosKeytabGetInstance1) Set(val *KerberosKeytabGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableKerberosKeytabGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableKerberosKeytabGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKerberosKeytabGetInstance1(val *KerberosKeytabGetInstance1) *NullableKerberosKeytabGetInstance1 {
	return &NullableKerberosKeytabGetInstance1{value: val, isSet: true}
}

func (v NullableKerberosKeytabGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKerberosKeytabGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
