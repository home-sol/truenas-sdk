...
// checks if the PoolGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolGetInstance1{}

// PoolGetInstance1 struct for PoolGetInstance1
type PoolGetInstance1 struct {
...
func (o *PoolGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *PoolGetInstance1) SetExtendContextNil() {
...
func (o *PoolGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o PoolGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o PoolGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullablePoolGetInstance1 struct {
	value *PoolGetInstance1
	isSet bool
}

func (v NullablePoolGetInstance1) Get() *PoolGetInstance1 {
	return v.value
}

func (v *NullablePoolGetInstance1) Set(val *PoolGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullablePoolGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullablePoolGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoolGetInstance1(val *PoolGetInstance1) *NullablePoolGetInstance1 {
	return &NullablePoolGetInstance1{value: val, isSet: true}
}

func (v NullablePoolGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoolGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
