...
// checks if the IscsiTargetGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiTargetGetInstance1{}

// IscsiTargetGetInstance1 struct for IscsiTargetGetInstance1
type IscsiTargetGetInstance1 struct {
...
func (o *IscsiTargetGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *IscsiTargetGetInstance1) SetExtendContextNil() {
...
func (o *IscsiTargetGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o IscsiTargetGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o IscsiTargetGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableIscsiTargetGetInstance1 struct {
	value *IscsiTargetGetInstance1
	isSet bool
}

func (v NullableIscsiTargetGetInstance1) Get() *IscsiTargetGetInstance1 {
	return v.value
}

func (v *NullableIscsiTargetGetInstance1) Set(val *IscsiTargetGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableIscsiTargetGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableIscsiTargetGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIscsiTargetGetInstance1(val *IscsiTargetGetInstance1) *NullableIscsiTargetGetInstance1 {
	return &NullableIscsiTargetGetInstance1{value: val, isSet: true}
}

func (v NullableIscsiTargetGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIscsiTargetGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
