...
// checks if the InterfaceGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InterfaceGetInstance1{}

// InterfaceGetInstance1 struct for InterfaceGetInstance1
type InterfaceGetInstance1 struct {
...
func (o *InterfaceGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *InterfaceGetInstance1) SetExtendContextNil() {
...
func (o *InterfaceGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o InterfaceGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o InterfaceGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableInterfaceGetInstance1 struct {
	value *InterfaceGetInstance1
	isSet bool
}

func (v NullableInterfaceGetInstance1) Get() *InterfaceGetInstance1 {
	return v.value
}

func (v *NullableInterfaceGetInstance1) Set(val *InterfaceGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableInterfaceGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableInterfaceGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInterfaceGetInstance1(val *InterfaceGetInstance1) *NullableInterfaceGetInstance1 {
	return &NullableInterfaceGetInstance1{value: val, isSet: true}
}

func (v NullableInterfaceGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInterfaceGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
