...
// checks if the PoolDatasetChangeKey1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolDatasetChangeKey1{}
...
func (o PoolDatasetChangeKey1) ToMap() (map[string]interface{}, error) {
