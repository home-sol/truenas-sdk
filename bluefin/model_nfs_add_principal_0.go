...
// checks if the NfsAddPrincipal0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NfsAddPrincipal0{}
...
func (o NfsAddPrincipal0) ToMap() (map[string]interface{}, error) {
