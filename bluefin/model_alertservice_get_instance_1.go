...
// checks if the AlertserviceGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertserviceGetInstance1{}

// AlertserviceGetInstance1 struct for AlertserviceGetInstance1
type AlertserviceGetInstance1 struct {
...
func (o *AlertserviceGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *AlertserviceGetInstance1) SetExtendContextNil() {
...
func (o *AlertserviceGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o AlertserviceGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o AlertserviceGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableAlertserviceGetInstance1 struct {
	value *AlertserviceGetInstance1
	isSet bool
}

func (v NullableAlertserviceGetInstance1) Get() *AlertserviceGetInstance1 {
	return v.value
}

func (v *NullableAlertserviceGetInstance1) Set(val *AlertserviceGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertserviceGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertserviceGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertserviceGetInstance1(val *AlertserviceGetInstance1) *NullableAlertserviceGetInstance1 {
	return &NullableAlertserviceGetInstance1{value: val, isSet: true}
}

func (v NullableAlertserviceGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertserviceGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
