...
// checks if the FailoverUpgrade0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailoverUpgrade0{}
...
func (o FailoverUpgrade0) ToMap() (map[string]interface{}, error) {
