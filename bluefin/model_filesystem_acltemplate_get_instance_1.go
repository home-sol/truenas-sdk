...
// checks if the FilesystemAcltemplateGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FilesystemAcltemplateGetInstance1{}

// FilesystemAcltemplateGetInstance1 struct for FilesystemAcltemplateGetInstance1
type FilesystemAcltemplateGetInstance1 struct {
...
func NewFilesystemAcltemplateGetInstance1() *FilesystemAcltemplateGetInstance1 {
	this := FilesystemAcltemplateGetInstance1{}
...
func (o *FilesystemAcltemplateGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *FilesystemAcltemplateGetInstance1) SetExtendContextNil() {
...
func (o *FilesystemAcltemplateGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o FilesystemAcltemplateGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o FilesystemAcltemplateGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableFilesystemAcltemplateGetInstance1 struct {
	value *FilesystemAcltemplateGetInstance1
	isSet bool
}

func (v NullableFilesystemAcltemplateGetInstance1) Get() *FilesystemAcltemplateGetInstance1 {
	return v.value
}

func (v *NullableFilesystemAcltemplateGetInstance1) Set(val *FilesystemAcltemplateGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableFilesystemAcltemplateGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableFilesystemAcltemplateGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFilesystemAcltemplateGetInstance1(val *FilesystemAcltemplateGetInstance1) *NullableFilesystemAcltemplateGetInstance1 {
	return &NullableFilesystemAcltemplateGetInstance1{value: val, isSet: true}
}

func (v NullableFilesystemAcltemplateGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFilesystemAcltemplateGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
