...
// checks if the Specialvdevs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Specialvdevs{}
...
func (o Specialvdevs) ToMap() (map[string]interface{}, error) {
