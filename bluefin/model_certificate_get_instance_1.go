...
// checks if the CertificateGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateGetInstance1{}

// CertificateGetInstance1 struct for CertificateGetInstance1
type CertificateGetInstance1 struct {
...
func (o *CertificateGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *CertificateGetInstance1) SetExtendContextNil() {
...
func (o *CertificateGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o CertificateGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o CertificateGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableCertificateGetInstance1 struct {
	value *CertificateGetInstance1
	isSet bool
}

func (v NullableCertificateGetInstance1) Get() *CertificateGetInstance1 {
	return v.value
}

func (v *NullableCertificateGetInstance1) Set(val *CertificateGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateGetInstance1(val *CertificateGetInstance1) *NullableCertificateGetInstance1 {
	return &NullableCertificateGetInstance1{value: val, isSet: true}
}

func (v NullableCertificateGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
