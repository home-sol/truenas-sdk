...
// checks if the SmbStatus2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbStatus2{}
...
func (o SmbStatus2) ToMap() (map[string]interface{}, error) {
