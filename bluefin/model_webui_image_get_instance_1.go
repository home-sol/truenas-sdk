...
// checks if the WebuiImageGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebuiImageGetInstance1{}

// WebuiImageGetInstance1 struct for WebuiImageGetInstance1
type WebuiImageGetInstance1 struct {
...
func (o *WebuiImageGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *WebuiImageGetInstance1) SetExtendContextNil() {
...
func (o *WebuiImageGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o WebuiImageGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o WebuiImageGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableWebuiImageGetInstance1 struct {
	value *WebuiImageGetInstance1
	isSet bool
}

func (v NullableWebuiImageGetInstance1) Get() *WebuiImageGetInstance1 {
	return v.value
}

func (v *NullableWebuiImageGetInstance1) Set(val *WebuiImageGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableWebuiImageGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableWebuiImageGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebuiImageGetInstance1(val *WebuiImageGetInstance1) *NullableWebuiImageGetInstance1 {
	return &NullableWebuiImageGetInstance1{value: val, isSet: true}
}

func (v NullableWebuiImageGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebuiImageGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
