...
// checks if the StaticrouteGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaticrouteGetInstance1{}

// StaticrouteGetInstance1 struct for StaticrouteGetInstance1
type StaticrouteGetInstance1 struct {
...
func (o *StaticrouteGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *StaticrouteGetInstance1) SetExtendContextNil() {
...
func (o *StaticrouteGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o StaticrouteGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o StaticrouteGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableStaticrouteGetInstance1 struct {
	value *StaticrouteGetInstance1
	isSet bool
}

func (v NullableStaticrouteGetInstance1) Get() *StaticrouteGetInstance1 {
	return v.value
}

func (v *NullableStaticrouteGetInstance1) Set(val *StaticrouteGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableStaticrouteGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableStaticrouteGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaticrouteGetInstance1(val *StaticrouteGetInstance1) *NullableStaticrouteGetInstance1 {
	return &NullableStaticrouteGetInstance1{value: val, isSet: true}
}

func (v NullableStaticrouteGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaticrouteGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
