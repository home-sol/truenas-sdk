...
// checks if the UserProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserProperty{}
...
func (o UserProperty) ToMap() (map[string]interface{}, error) {
