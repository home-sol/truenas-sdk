...
// checks if the InitshutdownscriptGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InitshutdownscriptGetInstance1{}

// InitshutdownscriptGetInstance1 struct for InitshutdownscriptGetInstance1
type InitshutdownscriptGetInstance1 struct {
...
func NewInitshutdownscriptGetInstance1() *InitshutdownscriptGetInstance1 {
	this := InitshutdownscriptGetInstance1{}
...
func (o *InitshutdownscriptGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *InitshutdownscriptGetInstance1) SetExtendContextNil() {
...
func (o *InitshutdownscriptGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o InitshutdownscriptGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o InitshutdownscriptGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableInitshutdownscriptGetInstance1 struct {
	value *InitshutdownscriptGetInstance1
	isSet bool
}

func (v NullableInitshutdownscriptGetInstance1) Get() *InitshutdownscriptGetInstance1 {
	return v.value
}

func (v *NullableInitshutdownscriptGetInstance1) Set(val *InitshutdownscriptGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableInitshutdownscriptGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableInitshutdownscriptGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInitshutdownscriptGetInstance1(val *InitshutdownscriptGetInstance1) *NullableInitshutdownscriptGetInstance1 {
	return &NullableInitshutdownscriptGetInstance1{value: val, isSet: true}
}

func (v NullableInitshutdownscriptGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInitshutdownscriptGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
