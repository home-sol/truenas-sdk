...
// checks if the KeychaincredentialGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeychaincredentialGetInstance1{}

// KeychaincredentialGetInstance1 struct for KeychaincredentialGetInstance1
type KeychaincredentialGetInstance1 struct {
...
func NewKeychaincredentialGetInstance1() *KeychaincredentialGetInstance1 {
	this := KeychaincredentialGetInstance1{}
...
func (o *KeychaincredentialGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *KeychaincredentialGetInstance1) SetExtendContextNil() {
...
func (o *KeychaincredentialGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o KeychaincredentialGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o KeychaincredentialGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableKeychaincredentialGetInstance1 struct {
	value *KeychaincredentialGetInstance1
	isSet bool
}

func (v NullableKeychaincredentialGetInstance1) Get() *KeychaincredentialGetInstance1 {
	return v.value
}

func (v *NullableKeychaincredentialGetInstance1) Set(val *KeychaincredentialGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableKeychaincredentialGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableKeychaincredentialGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeychaincredentialGetInstance1(val *KeychaincredentialGetInstance1) *NullableKeychaincredentialGetInstance1 {
	return &NullableKeychaincredentialGetInstance1{value: val, isSet: true}
}

func (v NullableKeychaincredentialGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeychaincredentialGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
