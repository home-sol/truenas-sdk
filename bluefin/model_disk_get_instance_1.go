...
// checks if the DiskGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskGetInstance1{}

// DiskGetInstance1 struct for DiskGetInstance1
type DiskGetInstance1 struct {
...
func (o *DiskGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *DiskGetInstance1) SetExtendContextNil() {
...
func (o *DiskGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o DiskGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o DiskGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableDiskGetInstance1 struct {
	value *DiskGetInstance1
	isSet bool
}

func (v NullableDiskGetInstance1) Get() *DiskGetInstance1 {
	return v.value
}

func (v *NullableDiskGetInstance1) Set(val *DiskGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskGetInstance1(val *DiskGetInstance1) *NullableDiskGetInstance1 {
	return &NullableDiskGetInstance1{value: val, isSet: true}
}

func (v NullableDiskGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
