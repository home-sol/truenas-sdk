...
// checks if the TunableGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TunableGetInstance1{}

// TunableGetInstance1 struct for TunableGetInstance1
type TunableGetInstance1 struct {
...
func (o *TunableGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *TunableGetInstance1) SetExtendContextNil() {
...
func (o *TunableGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o TunableGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o TunableGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableTunableGetInstance1 struct {
	value *TunableGetInstance1
	isSet bool
}

func (v NullableTunableGetInstance1) Get() *TunableGetInstance1 {
	return v.value
}

func (v *NullableTunableGetInstance1) Set(val *TunableGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableTunableGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableTunableGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTunableGetInstance1(val *TunableGetInstance1) *NullableTunableGetInstance1 {
	return &NullableTunableGetInstance1{value: val, isSet: true}
}

func (v NullableTunableGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTunableGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
