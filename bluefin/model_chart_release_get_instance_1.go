...
// checks if the ChartReleaseGetInstance1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChartReleaseGetInstance1{}

// ChartReleaseGetInstance1 struct for ChartReleaseGetInstance1
type ChartReleaseGetInstance1 struct {
...
func (o *ChartReleaseGetInstance1) SetExtendNil() {
	o.Extend.Set(nil)
}
...
func (o *ChartReleaseGetInstance1) SetExtendContextNil() {
...
func (o *ChartReleaseGetInstance1) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o ChartReleaseGetInstance1) MarshalJSON() ([]byte, error) {
...
func (o ChartReleaseGetInstance1) ToMap() (map[string]interface{}, error) {
...
type NullableChartReleaseGetInstance1 struct {
	value *ChartReleaseGetInstance1
	isSet bool
}

func (v NullableChartReleaseGetInstance1) Get() *ChartReleaseGetInstance1 {
	return v.value
}

func (v *NullableChartReleaseGetInstance1) Set(val *ChartReleaseGetInstance1) {
	v.value = val
	v.isSet = true
}

func (v NullableChartReleaseGetInstance1) IsSet() bool {
	return v.isSet
}

func (v *NullableChartReleaseGetInstance1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChartReleaseGetInstance1(val *ChartReleaseGetInstance1) *NullableChartReleaseGetInstance1 {
	return &NullableChartReleaseGetInstance1{value: val, isSet: true}
}

func (v NullableChartReleaseGetInstance1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChartReleaseGetInstance1) UnmarshalJSON(src []byte) error {
	v.isSet = true
