...
// checks if the CloudsyncSyncOnetime0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudsyncSyncOnetime0{}
...
func (o CloudsyncSyncOnetime0) ToMap() (map[string]interface{}, error) {
