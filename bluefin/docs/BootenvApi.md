...
[**BootenvGetInstancePost**](BootenvApi.md#BootenvGetInstancePost) | **Post** /bootenv/get_instance | 
...
func main() {
    ...
    r, err := apiClient.BootenvApi.BootenvGet(context.Background()).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
## BootenvGetInstancePost

> BootenvGetInstancePost(ctx).BootenvGetInstance(bootenvGetInstance).Execute()
...
func main() {
    bootenvGetInstance := *openapiclient.NewBootenvGetInstance() // BootenvGetInstance |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.BootenvApi.BootenvGetInstancePost(context.Background()).BootenvGetInstance(bootenvGetInstance).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `BootenvApi.BootenvGetInstancePost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiBootenvGetInstancePostRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bootenvGetInstance** | [**BootenvGetInstance**](BootenvGetInstance.md) |  | 
...
> BootenvIdIdActivatePost(ctx, id).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.BootenvApi.BootenvIdIdActivatePost(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.BootenvApi.BootenvIdIdDelete(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.BootenvApi.BootenvIdIdGet(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.BootenvApi.BootenvIdIdPut(context.Background(), id).Execute()
    if err != nil {
...
> BootenvIdIdSetAttributePost(ctx, id).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.BootenvApi.BootenvIdIdSetAttributePost(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.BootenvApi.BootenvPost(context.Background()).BootenvCreate0(bootenvCreate0).Execute()
    if err != nil {
